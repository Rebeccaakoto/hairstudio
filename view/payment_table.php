        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
                    <form
                        class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" method='post' action='payments_table.php'>
                        <div class="input-group">
                            <input type="text" class="form-control bg-light border-0 small" name="search_payment" placeholder="Search by date..."
                                aria-label="Search" aria-describedby="basic-addon2">
                            <div class="input-group-append">
                                <input class="btn btn-primary" type="submit" name="paysearch" value="search">
...
<div class="modal fade" id="paymodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="POST" action="../actions/payment_action.php" class="row g-3">
  <div class="col-md-6">
...
<tbody>
    <tr>
    <td><?php echo $searchresult["pay_id"] ?></td>
      <td><?php echo $searchresult["customer_id"] ?></td>
      <td><?php echo $searchresult["currency"]; ?></td>
      <td><?php echo $searchresult["amt"]; ?></td>
      <td><?php echo $searchresult["order_id"] ?></td>
      <td><?php echo $searchresult["payment_date"] ?></td>
    </tr>
  </tbody>
  </table>
...
?>
  ...
  <tbody>
    <tr>
      ...
      <td> 
      <form class="d-inline-flex" action="../actions/payment_action.php" method="post">
