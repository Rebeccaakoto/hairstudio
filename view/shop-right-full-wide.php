        ...
        <div class="col-md-10">
            <div class="row p-2 bg-white border rounded">
                ...
                <div class="align-items-center align-content-center col-md-3 border-left mt-1">
                    ...
                    <div class="d-flex flex-column mt-4"><a href="single-product.php? &id=<?php echo $row["product_id"] .'&ipadd='.$ipadd.'&qty='.$qty  ?>" ><button class="btn btn-primary btn-sm" type="submit">See Product</button></a></div>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <div class="product-thumb-carousel owl-carousel">
                                    <div class="single-thumb-item">
                                        <a href="single-product.html"><img class="img-fluid"
                                                                           src="assets/img/hair8 (8).jpeg"
                                                                           alt="Product"/></a>
                                    </div>

                                    <div class="single-thumb-item">
                                        <a href="single-product.html"><img class="img-fluid"
                                                                           src="assets/img/hair8 (18).jpeg"
                                                                           alt="Product"/></a>
                                    </div>

                                    <div class="single-thumb-item">
                                        <a href="single-product.html"><img class="img-fluid"
                                                                           src="assets/img/hair8 (15).jpeg"
                                                                           alt="Product"/></a>
                                    </div>
